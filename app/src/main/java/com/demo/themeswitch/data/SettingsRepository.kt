...
class SettingsRepository(private val context: Context) {
    ...
    val preferencesFlow: Flow<AppPreferences> = context.dataStore.data.map { prefs ->
        AppPreferences(
            ...
            enableBlur = prefs[PreferencesKeys.ENABLE_BLUR] ?: false,
            ...
            enableScrollAnimation = prefs[PreferencesKeys.ENABLE_SCROLL_ANIMATION] ?: false,
            enablePredictiveBack = prefs[PreferencesKeys.ENABLE_PREDICTIVE_BACK] ?: false,
